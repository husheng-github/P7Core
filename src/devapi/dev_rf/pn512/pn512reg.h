...
#define     JREG_FELNFC1         0x1A      /* */
#define     JREG_FELNFC2         0x1B      /* */
#define     JREG_MIFNFC          0x1C      /* */
#define     JREG_MANUALRCVREG    0x1D      /* */
#define     JREG_TYPEB           0x1E      /*   < Configure the ISO14443 type B.           */
...
#define     JREG_GSNON           0x27      /*!< Contains the conductance and the modulation settings for
...
#define     JBIT_RDERR              0x20   /*!< Bit position for Temerature Error. */
...
#define     JBIT_RXMULOTIPLE        0x04   /*!< If 1, */
...
#define     JBIT_ISO14443B        0x03   /*!< Define the ISO14443B framing used for data transmission. */
