...
typedef int     (*pci_firmware_api_readandcheckappkey)(u8 groupindex,u8 keytype,u8 keyindex,u8 *keylen,u8 *keydata);
typedef int     (*pci_firmware_api_deleteppkey)(u8 groupindex,u8 keytype,u8 keyindex);
typedef int     (*pci_firmware_api_saveappkey)(u8 groupindex,u8 keytype,u8 keyindex,u8 keylen,u8 *keydata);
typedef int (*pci_firmware_api_dryice_isrhandler)(void);
typedef int     (*pci_firmware_api_dukptk_load)(strDukptInitInfo* lpstrDukptInitInfo);
typedef int     (*pci_firmware_api_dukpt_check_keytmp)(u32 nKeyGroup, u32 nKsnIndex,strDevDukpt *lpstrDevDukpt);
...
typedef int     (*pci_firmware_api_pciarith_file_hash)(u32 fileorgaddr,u32 filestaoffset,u32 inlen,u8 *hashvalue,u8 hashtype);
typedef int     (*pci_firmware_api_dev_trng_read)(u8 *trngdata,u32 trngdatalen);
